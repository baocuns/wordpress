    ...
    UpdateMetadataInterface
{
    ...
    private static function getGuzzleMajorVersion()
    {
        ...
        if (defined('Automattic\WooCommerce\GoogleListingsAndAds\Vendor\GuzzleHttp\ClientInterface::VERSION')) {
    ...
    public static function makeHttpClient(
        ...
        if (self::getGuzzleMajorVersion() === 5) {
            $client = new \Automattic\WooCommerce\GoogleListingsAndAds\Vendor\GuzzleHttp\Client($httpClientOptions);
